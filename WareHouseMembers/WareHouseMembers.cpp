...
bool WareHouseMembers::on_txtFileEntry_pushButton_clicked()
{
    ...
    file.close();
    ui->textBrowser->setText(QString::fromStdString("Name: " + members_name->output_linkedlist() + '\n' +
                                                    "ID#: " + members_id->output_linkedlist() + '\n' +
                                                    "Type: " + members_date->output_linkedlist() + '\n' +
                                                    "Date: " + members_type->output_linkedlist() + '\n' ));
...
void WareHouseMembers::on_Add_Enter_pushButton_clicked()
{
    std::string user_string_input = ui->Add_lineEdit->text().toStdString();
    members_name->push_back(user_string_input);
    members_name->select_sort();
    ui->textBrowser->setText(QString::fromStdString("New Members: " + members_name->output_linkedlist() + '\n'));
}
